import { AVAX, BNB, DEV, MATIC, ChainId, ETHER, HECO, JSBI, Percent, Token, WETH } from '@skylaunch/sdk'
...
export const SKYFI: { [chainId in ChainId]: Token } = {
  [ChainId.MAINNET]: new Token(ChainId.MAINNET, ZERO_ADDRESS, 18, 'SKYFI', 'SkyLaunch'),
  [ChainId.RINKEBY]: new Token(ChainId.RINKEBY, '0x398dD6876a780cc016108ce674B3A7A5d226d62c', 18, 'SKYFI', 'SkyLaunch'),
  [ChainId.ROPSTEN]: new Token(ChainId.ROPSTEN, ZERO_ADDRESS, 18, 'SKYFI', 'SkyLaunch'),
  [ChainId.GÖRLI]: new Token(ChainId.GÖRLI, ZERO_ADDRESS, 18, 'SKYFI', 'SkyLaunch'),
  [ChainId.KOVAN]: new Token(ChainId.KOVAN, ZERO_ADDRESS, 18, 'SKYFI', 'SkyLaunch'),
  [ChainId.FUJI]: new Token(ChainId.FUJI, ZERO_ADDRESS, 18, 'SKYFI', 'SkyLaunch'),
  [ChainId.AVALANCHE]: new Token(ChainId.AVALANCHE, ZERO_ADDRESS, 18, 'SKYFI', 'SkyLaunch'),
  [ChainId.SMART_CHAIN]: new Token(ChainId.SMART_CHAIN, ZERO_ADDRESS, 18, 'SKYFI', 'SkyLaunch'),
  [ChainId.SMART_CHAIN_TEST]: new Token(ChainId.SMART_CHAIN, ZERO_ADDRESS, 18, 'SKYFI', 'SkyLaunch'),
  [ChainId.MOONBASE_ALPHA]: new Token(ChainId.MOONBASE_ALPHA, ZERO_ADDRESS, 18, 'SKYFI', 'SkyLaunch'),
  [ChainId.MUMBAI]: new Token(ChainId.MUMBAI, ZERO_ADDRESS, 18, 'SKYFI', 'SkyLaunch'),
  [ChainId.MATIC]: new Token(ChainId.MATIC, ZERO_ADDRESS, 18, 'SKYFI', 'SkyLaunch'),
  [ChainId.HECO]: new Token(ChainId.HECO, ZERO_ADDRESS, 18, 'SKYFI', 'SkyLaunch')
}
...
export const NATIVE_TOKEN = {
  [ChainId.MAINNET]: new Token(ChainId.MAINNET, ZERO_ADDRESS, ETHER.decimals, ETHER.symbol, ETHER.name),
  [ChainId.RINKEBY]: new Token(ChainId.RINKEBY, ZERO_ADDRESS, ETHER.decimals, ETHER.symbol, ETHER.name),
  [ChainId.FUJI]: new Token(ChainId.FUJI, ZERO_ADDRESS, AVAX.decimals, AVAX.symbol, AVAX.name),
  [ChainId.AVALANCHE]: new Token(ChainId.AVALANCHE, ZERO_ADDRESS, AVAX.decimals, AVAX.symbol, AVAX.name),
  [ChainId.SMART_CHAIN]: new Token(ChainId.SMART_CHAIN, ZERO_ADDRESS, BNB.decimals, BNB.symbol, BNB.name),
  [ChainId.SMART_CHAIN_TEST]: new Token(ChainId.SMART_CHAIN_TEST, ZERO_ADDRESS, BNB.decimals, BNB.symbol, BNB.name),
  [ChainId.MOONBASE_ALPHA]: new Token(ChainId.MOONBASE_ALPHA, ZERO_ADDRESS, DEV.decimals, DEV.symbol, DEV.name),
  [ChainId.MUMBAI]: new Token(ChainId.MUMBAI, ZERO_ADDRESS, MATIC.decimals, MATIC.symbol, MATIC.name),
