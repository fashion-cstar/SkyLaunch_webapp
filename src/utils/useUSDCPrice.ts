import { ChainId, Currency, currencyEquals, JSBI, Price, WETH } from '@skylaunch/sdk'
import { useMemo } from 'react'
import { rinkebyUSDC, USDC } from '../constants'
  ...
  const tokenPairs: [Currency | undefined, Currency | undefined][] = useMemo(
    () => [
      ...
      [
        ...
        chainId === ChainId.MAINNET ? USDC : chainId === ChainId.RINKEBY ? rinkebyUSDC : undefined
      ],
      [
        chainId ? WETH[chainId] : undefined,
        chainId === ChainId.MAINNET ? USDC : chainId === ChainId.RINKEBY ? rinkebyUSDC : undefined
